...
function equipmentPDF(equipmentsFiltered: EquipmentType[]) {
  ...
  const dados = equipmentsFiltered.map((e) => {
    return [
      { text: e.id, fontSize: 9, margin: [0, 2, 0, 2] },
      { text: e.nome, fontSize: 9, margin: [0, 2, 0, 2] },
      { text: e.modelo, fontSize: 9, margin: [0, 2, 0, 2] },
      { text: e.marca, fontSize: 9, margin: [0, 2, 0, 2] },
      ...
      table: {
        ...
        body: [
          [
            ...
            { text: 'Modelo', style: 'tableHeader', fontSize: 11, bold: true },
            { text: 'Marca', style: 'tableHeader', fontSize: 11, bold: true },
